                ...
                <div className="p-6">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="mb-6">
                      ...
                      {/* Clickable Square Image Panel - click anywhere to open file picker */}
                      <div className="flex flex-col items-center">
                        <div
                          onClick={() => fileInputRef.current?.click()}
                          className="relative bg-gray-50 border-2 border-dashed border-blue-300 rounded-2xl w-40 h-40 flex flex-col items-center justify-center overflow-hidden cursor-pointer hover:bg-gray-100 hover:border-blue-400 transition-all group"
                        >
                          <input
                            ref={fileInputRef}
                            type="file"
                          ...
                          {newStaff.imagePreview ? (
                            <>
                              ...
                              <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                                <span className="bg-black/60 text-white text-xs px-2 py-1 rounded-lg">Change Photo</span>
                              </div>
                            </>
                          ) : (
                            <div className="text-gray-300 flex flex-col items-center group-hover:text-blue-400 transition-colors">
                              <svg
                              ...
                              <span className="text-xs font-medium mt-1">Click to upload</span>
                            </div>
                          )}
                        </div>
