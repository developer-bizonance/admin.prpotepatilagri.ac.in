...
import EminentGuestsDashboard from "./home-sections/EminentGuest";
import FacultyAdmin from "./home-sections/FacultyAdmin";
import PopupEventsDashboard from "./PopupEventsDashboard";
...
const HomeDashboard = () => {
  ...
  const sections = [
...

    {
      ...
      title: "Popup Banners",
      icon: <ImageIcon size={20} />,
      stats: "Manage homepage popup banners",
      action: "Manage popup banners",
      content: <PopupEventsDashboard />,
    },
...

    {
    ...
    },
     {
      ...
      stats: "Manage faculty administration",
      action: "Manage faculty",
      content: <FacultyAdmin />,
    },
    {
