...
// 🌟 IMAGE FORMATTING HELPER (ADDED BACK) 🌟
...
const CardManager = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = editingId
        ? `${BACKEND_URL}/api/admin-cards/${editingId}`
        : `${BACKEND_URL}/api/admin-cards`;
    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-10 font-sans">
      ...
      {loading ? (
        ...
        <div className="max-w-6xl mx-auto space-y-10">
          ...
          {cards.map((card) => {
            const displayImgSrc = getImageSrc(card.image);
            ...
            return (
              ...
              >
                ...
                <div className="w-full md:w-2/3 p-8 md:p-12 relative">
                  ...
                  <h1 className="text-2xl md:text-3xl font-bold text-blue-900 mb-8 pl-0 md:pl-6">
                    {card.noteTitle}
                  </h1>

                  <div className="space-y-6 text-gray-700 leading-relaxed text-justify md:pl-6">
        ...
        <div className="flex flex-col h-full">
          ...
          >
            ...
            <div className="flex gap-3 pt-4 border-t sticky bottom-0 bg-white mt-auto">
              ...
              <button
                type="submit"
                className="flex-1 px-4 py-3 bg-blue-400/30 text-blue-950 rounded-lg font-medium shadow-lg hover:bg-blue-300 transition-colors"
              >
                Save
              </button>
            </div>
